import { ArrowRight, MessagesSquare } from '@/components/ui/icons'
import { FC } from 'react'

export const ForumRecentThreadsSection: FC = () => {
	return (
		<div className="flex flex-col gap-2">
			...
			<div className="bg-card rounded-md px-4 py-3 border shadow">
				<div className="flex flex-col gap-2">
